...
public class VRRayCaster : GraphicRaycaster, IPointerEnterHandler
{
    ...
    protected override void Start()
    {
        ...
        {
            Debug.LogError("Canvas does not have an event camera attached. Please Attaching OVRCameraRig.centerEyeAnchor as default.");
    ...
    private void Raycast(PointerEventData eventData, List<RaycastResult> resultAppendList, Ray ray, bool checkForBlocking)
    {
        ...
        var m_RaycastResults = new List<RaycastHit>();
    ...
    public override void Raycast(PointerEventData eventData, List<RaycastResult> resultAppendList)
    {
        ...
        {
            Raycast(eventData, resultAppendList, (eventData as VRPointerEventData).worldSpaceRay, true);
        }
    }
