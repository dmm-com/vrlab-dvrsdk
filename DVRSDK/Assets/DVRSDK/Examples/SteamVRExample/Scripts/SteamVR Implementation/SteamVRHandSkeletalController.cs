...
public class SteamVRHandSkeletalController : MonoBehaviour
{
#if !UNITY_ANDROID
    [SerializeField]
    private SteamVR_Action_Skeleton LeftSkeletonAction;
    [SerializeField]
    private SteamVR_Action_Skeleton RightSkeletonAction;

    [Header("コントローラーに合わせて曲げるか完全に曲げるか")]
    [SerializeField]
    private EVRSkeletalMotionRange RangeOfMotion;
#endif
    ...
    void Awake()
    {
        ...
        LeftSkeletonAction.rangeOfMotion = RangeOfMotion;
        RightSkeletonAction.rangeOfMotion = RangeOfMotion;
    }

    private void SteamVR_Input_onSkeletonsUpdated(bool skipSendingEvents)
    {
        leftBonePositions = LeftSkeletonAction.GetBonePositions();
        leftBoneRotations = LeftSkeletonAction.GetBoneRotations();
        rightBonePositions = RightSkeletonAction.GetBonePositions();
        rightBoneRotations = RightSkeletonAction.GetBoneRotations();
    }
    ...
    private void UpdateHandController()
    {
