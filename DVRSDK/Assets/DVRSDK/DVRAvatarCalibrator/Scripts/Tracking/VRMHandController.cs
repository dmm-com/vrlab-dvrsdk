...
namespace DVRSDK.Avatar.Tracking
{
        ...
        private List<HumanBodyBones> FingerBones = new List<HumanBodyBones>
    {
        ...
        */
        ...
        void Update()
        {
            if (doLeftAnimation && (leftAnimationController != null & leftAnimationController.Next() == false))
            {
                doLeftAnimation = false;
            }
            if (doRightAnimation && (rightAnimationController != null & rightAnimationController.Next() == false))
            {
